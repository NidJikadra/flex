    ...
    <div class="container">
        <div class="section-title">
            <div class="title-wrapper">
                ...
                <p class="description">Flex Solutions stands out with expert maintenance services, proactive monitoring,
                    and fast issue resolution. Our tailored plans ensure your website stays secure, up-to-date, and
                    optimized, allowing you to focus on growing your business stress-free.</p>
            </div>
        </div>

        <div class="tech-stack__skills">
            <ul class="tech-stack__skills-list">
                <li class="tech-stack__skills-button" data-tab="Benefits of Website Maintenance">Benefits of Website
                    Maintenance</li>
                <li class="tech-stack__skills-button tech-stack__skills-button--active" data-tab="frontend">How do I
                    Maintain my Website?
                </li>
                <li class="tech-stack__skills-button" data-tab="backend">Terms of Web Maintenance Contract</li>
                <li class="tech-stack__skills-button" data-tab="version-control">Tips for maintaining site effectively
                </li>
        ...
        <?php
            include 'includes/horizontal-tab.php';
        ?>
    </div>
</section>