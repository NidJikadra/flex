    ...
    <div class="hero-main">
        <div class="container">
            <div class="hero-wrapper">
                ...
                <h1 class="h1 word">Modern <span class="text-white">WordPress </span> Development</h1>
                ...
                <button type="button" class="button btn-secondary word">Start Your Projects<span class="icon"></span></button>
            </div>
        </div>
    </div>
